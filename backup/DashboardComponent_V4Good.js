  ...
  return (
    <div className="p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div className="border rounded-lg p-4 shadow">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={[
              ...
              {range: '30-60', count: filteredData.filter(d => parseInt(d.PasswordAgeInDays) >= 30 && parseInt(d.PasswordAgeInDays) < 60).length},
              {range: '60-90', count: filteredData.filter(d => parseInt(d.PasswordAgeInDays) >= 60 && parseInt(d.PasswordAgeInDays) < 90).length},
        ...
        <div className="border rounded-lg p-4 shadow">
          <h3 className="text-lg font-semibold mb-4">Accounts Disabled This Run</h3>
