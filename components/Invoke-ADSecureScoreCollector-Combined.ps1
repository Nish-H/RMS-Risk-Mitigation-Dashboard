...
try {
    ...
    $score  = 100
    $status = "Pass"
    $actual = if ($lapsInstalled) { "LAPS schema present. Installed on $lapsManaged/$lapsComputers computers ($pct%)" } else { "LAPS schema NOT present - may be deployed via O365/Intune" }
